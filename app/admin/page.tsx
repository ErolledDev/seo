...
import { Plus, ExternalLink, Copy, Edit, Trash2, Eye } from 'lucide-react';
        ...
        <TabsContent value="manage" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your existing redirect configurations
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="create" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure a new SEO-optimized redirect page
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>• Update your sitemap whenever you add new redirects</li>
